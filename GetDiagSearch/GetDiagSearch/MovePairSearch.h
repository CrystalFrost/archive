...
public:
	...
	void InitializeMoveSearch(char* start, char* result, char* checkpoint, char* temp);	// Инициализация поиска
...
private:
	...
	char* moveSearchGlobalHeader;					// Заголовок, после которого в файле идут данные о состоянии поиска методом перетасовки строк
	char* moveSearchComponentHeader;				// Заголовок, после которого в файле идут данные о состоянии компоненты перетасовки строк
};
