...
void Generator::Reset()
{
	...
	// Сброс значений структур генерации квадратов
		...
		checkpointFileName = 0;
		tempCheckpointFileName = 0;
		resultFileName = 0;
...
void Generator::Initialize(char* start, char* result, char* checkpoint, char* temp)
{
	fstream startFile;
...
void Generator::SetFileNames(char* start, char* result, char* checkpoint, char* temp)
{
	startParametersFileName = start;
	resultFileName = result;
	checkpointFileName = checkpoint;
